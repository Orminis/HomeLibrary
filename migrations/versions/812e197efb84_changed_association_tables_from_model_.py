...
def downgrade():
    ...
    sa.Column('user_condition', postgresql.ENUM('mint', 'fine', 'very_good', 'good', 'fair', 'poor', name='user_condition'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['reading_book_id'], ['reading_books.id'], name='users_reading_books_associations_reading_book_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['standard_user.id'], name='users_reading_books_associations_user_id_fkey'),
    ...
    sa.Column('user_comments', sa.TEXT(), autoincrement=False, nullable=False),
    sa.Column('user_rating', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['digital_book_id'], ['digital_books.id'], name='users_digital_books_associations_digital_book_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['standard_user.id'], name='users_digital_books_associations_user_id_fkey'),
    ...
    sa.Column('user_comments', sa.TEXT(), autoincrement=False, nullable=False),
    sa.Column('user_rating', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['audio_book_id'], ['audio_books.id'], name='users_audio_books_associations_audio_book_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['standard_user.id'], name='users_audio_books_associations_user_id_fkey'),
