...
def upgrade():
    ...
    op.add_column(
        "audio_books_for_approval", sa.Column("isbn", sa.BigInteger(), nullable=True)
    )
    ...
    op.add_column(
        "digital_books_for_approval", sa.Column("isbn", sa.BigInteger(), nullable=True)
    )
    ...
    op.add_column(
        "reading_books_for_approval", sa.Column("isbn", sa.BigInteger(), nullable=True)
    )
