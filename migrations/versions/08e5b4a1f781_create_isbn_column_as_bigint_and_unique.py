...
def upgrade():
    ...
    op.add_column('audio_books', sa.Column('isbn', sa.BigInteger(), nullable=True))
    op.create_unique_constraint(None, 'audio_books', ['isbn'])
    op.add_column('audio_books_for_approval', sa.Column('isbn', sa.BigInteger(), nullable=True))
    op.create_unique_constraint(None, 'audio_books_for_approval', ['isbn'])
    op.add_column('digital_books', sa.Column('isbn', sa.BigInteger(), nullable=True))
    op.create_unique_constraint(None, 'digital_books', ['isbn'])
    op.add_column('digital_books_for_approval', sa.Column('isbn', sa.BigInteger(), nullable=True))
    op.create_unique_constraint(None, 'digital_books_for_approval', ['isbn'])
    op.add_column('reading_books', sa.Column('isbn', sa.BigInteger(), nullable=True))
    op.create_unique_constraint(None, 'reading_books', ['isbn'])
    op.add_column('reading_books_for_approval', sa.Column('isbn', sa.BigInteger(), nullable=True))
