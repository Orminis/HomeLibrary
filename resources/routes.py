from resources.auth import (
    ...
    LoginUserResource,
    CreateCheckerResource,
    CreateAdminResource,
)

from resources.books import (
    AudioBooksResource,
    DigitalBooksResource,
    BooksResource,
    RejectReadingBookResource,
    ApproveReadingBookResource,
    ReadingBooksResource,
    DeleteReadingBooksResource,
)

from resources.users import (
    AddReadingBookToCollectionResource,
    RemoveReadingBookFromCollectionResource,
    PersonalUserResource,
    UserReadingBooksResource,
    UpdateUserResource,
)
